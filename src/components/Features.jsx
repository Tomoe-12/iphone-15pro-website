...
const Features = () => {
  ...
  useGSAP(() => {
    ...
    animateWithGsap('.g_grow', { scale: 1, opacity: 1, ease: 'power1' }, { scurb: 5.5 })
    animateWithGsap('.g_text', { y: 1, opacity: 1, ease: 'power2.inOut', duration: 1 }, )
  }, [])
                ...
                <div className="flex-1 flex-center">
                  <p className='feature-text g_text'>
                    ...
                    <span className='text-white'>
                      the first iPhone to feature on aerospace-grade titanium design,
                    </span>
